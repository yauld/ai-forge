from conditional_edge_demo import build_graph


def test_complete_form_goes_to_process_by_conditional_edge() -> None:
    graph = build_graph()
...
def test_incomplete_form_goes_to_ask_for_more_by_conditional_edge() -> None:
    graph = build_graph()
